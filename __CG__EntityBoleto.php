 ...
 */
class Boleto extends \Entity\Boleto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entity\\Boleto' . "\0" . 'id', '' . "\0" . 'Entity\\Boleto' . "\0" . 'id_rifa', '' . "\0" . 'Entity\\Boleto' . "\0" . 'numero', '' . "\0" . 'Entity\\Boleto' . "\0" . 'dueno', '' . "\0" . 'Entity\\Boleto' . "\0" . 'responsable', '' . "\0" . 'Entity\\Boleto' . "\0" . 'estado_dueno', '' . "\0" . 'Entity\\Boleto' . "\0" . 'estado_responsable'];
        }
    ...
    public function setDueno($dueno = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDueno', [$dueno]);

        return parent::setDueno($dueno);
    }
    ...
    public function getDueno()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDueno', []);

        return parent::getDueno();
    }
    ...
    public function setEstadoDueno($estadoDueno)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEstadoDueno', [$estadoDueno]);

        return parent::setEstadoDueno($estadoDueno);
    }
    ...
    public function getEstadoDueno()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEstadoDueno', []);

        return parent::getEstadoDueno();
    }
    ...
    public function setIdRifa(\Entity\Rifa $idRifa = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdRifa', [$idRifa]);

        return parent::setIdRifa($idRifa);
    }
    ...
    public function getIdRifa()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdRifa', []);
